...
/**
 * IncompleteSearchStringTest attempts to search an incomplete string in the database.
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Drum (C"), closeSoftKeyboard());
